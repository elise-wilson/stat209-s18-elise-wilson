...
**Answer**: Yes, with the decimal place rounded up to a whole number.
...
**Answer**: The range is 54785 to 59091.
...
**Answer**: No, because most of the data is out of the range.
...
**Answer**: Yes the data intersects.
...
reg_table (model, level = 0.80)
```

Make sure you actually extract the answer here:

**Answer**: The interval is from 33.07 to 34.65.
...
Using my procedure, the range that most murders in London between 2006 and 2011 were of people who were between the ages of 33.07 and 34.65 will be correct 80% of the time, and will be incorrect 20% of the time.
