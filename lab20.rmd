...
**Answer**: The slope coefficient tells us how much more expensive the diamond would be each time the quality goes up 1 carat. So, a 1 carat diamond would be $5000.
...
**Answer**: Yes, because it is not within the same confidence interval.

Would you be surprised if we collected another set of diamonds, in exactly the
same way as before, and found a slope estimate equal to 7500?

**Answer**: No, because it is within the same confidence interval.
...
**Answer**: The slope means that there is a definite positive relationship between price and diamond quality. So, as the quality (carat count) of the diamond goes up, so will the price.
...
**Answer**: The slope tells us that if the depth of the diamond is -29.65, then the price would be 5763.67. The lower the depth, the lower the price.
...
**Answer**: Both positive and negative, but with different variables.

Interpret this in words (your words, not just the formal definition).

**Answer**: Because the positives and negatives belong to different variables, the depth is negatively correlated with the price.
...
**Answer**: Yes. The signs of the depth are negative, and the signs of the carat are positive.
...
**Answer**: The slopes mean that as the carats increase, the price increases, but also as the depth increases, the price decreases. So there has to be a balancing out between the carats and the depth.
