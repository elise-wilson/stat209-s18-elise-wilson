...
Answer: As the mass of the male bird increases, so does the mass of their eggs. 
...
ggplot (birds, aes(male_mass, egg_mass)) +
  ...
  annotate ("text", x = 42.7, y = 11.50, label = "Parrots")
```
...
Answer: Yes, the size of the egg still increases with the size of the male bird. 
...
ggplot (birds, aes(male_mass, egg_mass)) +
  ...
  scale_x_log10 () +
  scale_y_log10 () +
  annotate ("point", x = 218.7, y = 87.00) +
  annotate ("text", x = 218.7, y = 87.00, label = "Red-Tailed Tropicbird")
```
...
ggplot (birds, aes(mating_system)) +
  ...
  xlab ("Mating System") +
  ylab ("Count") +
  ggtitle ("The Mating Systems of Swift Birds")
```
